...
1.æ‰“å¼€Fd
2.é v4l2_fmtdescæŸ¥è¯¢èƒ½åŠ›
3.è®¾ç½®èƒ½åŠ›

streaming:
4.ç”³è¯·buf  æœ‰å››ä¸ªbuf ä½†æ˜¯è¯»ä¸€ä¸ªå°±æ”¾ä¸€ä¸ª å’Œåªæœ‰ä¸€ä¸ªæ²¡åŒºåˆ«
5.è¯»buf
6.æ”¾å›žbuf


read/write
4.åªæœ‰ä¸€ä¸ªbuf è¯»ä¸€ä¸ªæ”¾ä¸€ä¸ª
...
static int V4l2InitDevice(char *strDevName, PT_VideoDevice ptVideoDevice)
{
    ...
    /* Èç¹ûÇý¶¯³ÌÐò·¢ÏÖÎÞ·¨Ä³Ð©²ÎÊý(±ÈÈç·Ö±æÂÊ),
     * Ëü»áµ÷ÕûÕâÐ©²ÎÊý, ²¢ÇÒ·µ»Ø¸øÓ¦ÓÃ³ÌÐò
     */
    ...
    else if (tV4l2Cap.capabilities & V4L2_CAP_READWRITE)
    {
        ...
        /* ÔÚÕâ¸ö³ÌÐòËùÄÜÖ§³ÖµÄ¸ñÊ½Àï, Ò»¸öÏóËØ×î¶àÖ»ÐèÒª4×Ö½Ú */
